...
%% This page's format is the old it applied until 2010.
%%
-module(create_old_page).
-export([execute/1]).
            ...
            receive
                Actual ->
                    ...
                    ?assertEqual({Pid, 200,
                                  lists:concat(
                                    [
                                     "||dummy||dummy||server_name1||server_name1||",
                                     "branch1||20120308-20120309||user_name1||purpose1||\n",
                                     "||dummy||dummy||server_name2||server_name2||",
                                     "branch2||20120310-20120311||user_name2||purpose2||\n"
                                    ])},
                                 Actual)
            end
        end)}.
